...
writer=SummaryWriter(logdir='run_color_grey',comment = 'Linear')
...
def train_net(net,
    ...
    dir_checkpoint = 'checkpoints_grey_color/'
    try:
    ...
    n = len(d)
    n_labeled = int(0.05 * n)
    n_unlabeled = n - int(0.05 * n)
    d_val = d[:n_labeled]
    d_train = d[n_labeled:]
    ...
    for epoch in range(epochs):
        ...
        print('Epoch labeled finished ! seg Loss: {}'.format(epoch_loss / int(0.05*n)))
