...
def train_net(net,
    ...
    dir_checkpoint = 'checkpoints_grey_both_'+str(ratio)+'datalr'+str(lr)+'k'+str(coeff)+'/'
    writer = SummaryWriter(logdir='run_both_grey_' + str(ratio) + 'datalr' + str(lr) + 'k' + str(coeff) + '/',
                           comment='Linear')
